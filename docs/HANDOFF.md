...
> 최소청약주식수, LLM 기반 청약 AI 진단 리포트, 기업 관련 상세정보,
> 상장 예정 공모주 현황 및 2026 신규상장 첫날 실전 성적표 대시보드,
> 그리고 **AI 월별 공모주 시장 트렌드 & 증시 정책/제도/이슈 종합 분석 리포트** 내역이 포함되어 있습니다.

# Handoff notes (2026-09-17) — 공모주(IPO) 종합 고도화 (청약·수요예측·기업정보 + 상장현황·첫날성적표 + AI 월별 시장·정책 리포트)
