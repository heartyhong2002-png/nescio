...
> 최소청약주식수, LLM 기반 청약 AI 진단 리포트, 그리고 **기업 관련 상세정보(업종·대표자·매출액·순이익·자본금·홈페이지) 및 비즈니스 모델 요약** 연동 내역이 포함되어 있습니다.

# Handoff notes (2026-09-17) — 공모주(IPO) 데이터 고도화, LLM 청약 AI 진단 리포트 및 기업 정보/비즈니스 모델 연동
