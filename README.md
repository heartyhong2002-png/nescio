...
8. 증권사 리포트 & 전문가 컨센서스 AI 요약 (개발 예정):
   - **증권사 목표가 & 컨센서스 게이지**: KIS 공식 API를 통한 평균 목표주가, 상승여력, 투자의견 점수 제공.
   - **최신 애널리스트 리포트 수집**: 네이버 증권 리서치 기반 증권사별 최근 리포트 제목, 목표가, 투자의견, 원문 PDF 링크 연동.
   - **초보자를 위한 AI 3줄 전문가 뷰**: 30페이지 분량의 어려운 리포트 전문 용어를 AI가 3줄로 알기 쉽게 번역 및 핵심 투자 포인트 요약.
